...
class Topbar extends Component{
	...
	render_bar(){
		...
		var outer=(
			<div className="w3-bar w3-black w3-padding-32">
				<button className="w3-button w3-text-red w3-bar-item logoFont w3-margin-left w3-xxlarge" onClick={this.setCurrent.bind(this,0)} >{'MawaBD'} </button> 
...
class FlightSearch extends Component{
		...
		if(this.state.one_way==0){
			...
			<div>
				<div className="w3-bar-item">
				  <label className="w3-left barFont">Departure</label> <br/>
				  <input className="w3-input w3-card w3-white" type="date" id="departDate" required/>
				</div>
				<div className="w3-bar-item">
				  <label className="w3-left barFont">Return</label> <br/>
				  <input className="w3-input w3-card w3-white" type="date" id="returnDate" required/>
				</div>
			</div>
			);
		}
	...
	render_Search(){
		var outer1,searchBar;
		if(this.state.one_way==0){
			searchBar=(
			<div className="w3-container w3-center w3-black">
				  <div className="horizontal-center">
					<div className="w3-twothird w3-card w3-red w3-padding-32">
					  <h2 className="barFont"> Search The Best Flights<br/>Only @ MawaBD</h2>
					  <br/>
					  <div className="w3-bar"> 
						<button className="w3-button w3-bar-item w3-black w3-round w3-ripple " onClick={this.toggleOne.bind(this,0)}>Round Trip</button>
						<button className="w3-button w3-black w3-bar-item w3-round w3-ripple w3-margin-left" onClick={this.toggleOne.bind(this,1)}>One Way</button>
					  </div>
					  <br/>
					  <div className="w3-bar w3-padding-left w3-padding-right">
						<div className="w3-bar-item">
						  <label className="w3-left barFont">From</label> <br/>
						  <input className="w3-input w3-card w3-white" placeholder="Source" type="text" id="sourceField" required/>
						</div>
						 <div className="w3-bar-item">
						  <label className="w3-left barFont">To</label> <br/>
						  <input className="w3-input w3-card w3-white" placeholder="Destination" type="text" id="destinationField" required/>
						</div>
						<div className="w3-bar-item">
							<label className="w3-left barFont">Departure</label> <br/>
							<input className="w3-input w3-card w3-white" type="date" id="departDate" required/>
					  ...
					  <div className="w3-bar w3-padding-left w3-padding-right">
						<div className="w3-bar-item">
						  <label className="w3-left">Adult(12+)</label> <br/>
						  <select className="w3-select w3-card w3-white" id="adultCount" required>
						...
						<div className="w3-bar-item">
						  <label className="w3-left">Children (2-11)</label> <br/>
						  <select className="w3-select w3-card w3-white" id="childCount">
						...
						<div className="w3-bar-item">
						  <label className="w3-left">{'Infant < 2'}</label> <br/>
						  <select className="w3-select w3-card w3-white" id="infantCount">
						...
						<div className="w3-bar-item">
						  <label className="w3-left">Class</label> <br/>
						  <select className="w3-select w3-card w3-white" id="classVal" required>
					  ...
					  <div className="w3-bar w3-margin-top">
						<button className="w3-button w3-bar-item w3-cyan w3-round barFont" >Search Flights </button>
					  </div>
					</div>
				  </div>
				  <br/><br/>
				  ...
				  <div className="horizontal-center">
					<div className="w3-twothird w3-card w3-red w3-padding-32">
					  ...
					  <div className="w3-bar w3-padding-left w3-padding-right">
						...
						<div className="w3-bar-item">
						  <label className="w3-left">Infant (&lt 2)</label> <br/>
						  <select className="w3-select w3-card w3-white" id="infantCount">
							<option value={0}>Choose number of Infants</option>
							<option value={1}>1</option>
							<option value={2}>2</option>
				...
				<div>
					...
					<div className="w3-container w3-black">
						<div className="w3-row ">
							<div className="w3-col w3-center w3-red" style="width:20%">
							  <p> Airlines</p>
							</div>
							<div className="w3-col w3-center w3-red sm-margin-left" style="width:20%">
							  <p> Departure</p>
							</div>
							<div className="w3-col w3-center w3-red sm-margin-left" style="width:20%">
							  <p> Arrival</p>
							...
							<div className="w3-col w3-center w3-red  sm-margin-left" style="width:19.72%">
							  <p> Price</p>
							</div>
						</div>
						<div className="w3-row w3-card w3-light-grey w3-border-bottom w3-border-black">
							<div className="w3-col w3-center w3-padding" style="width:20%">
							  <p>
								China Eastern Airlines - 2036 <br/>
								Aircraft: 73H <br/>
							  </p>
							</div>
							<div className="w3-col w3-center sm-margin-left w3-padding" style="width:20%">
							  <p>
								Dhaka (DAC)14:35
								Thursday, 17 May 18
							  </p>
							...
							<div className="w3-col w3-center sm-margin-left w3-pading" style="width:19.72%">
							  <p className="w3-text-red w3-large"> BDT 139327.87</p>
							  <p><button className="w3-button w3-ripple w3-red w3-round" onClick={this.setBook.bind(this)}>Buy</button></p>
							</div>
						</div>
						<div className="w3-row w3-card w3-light-grey w3-border-bottom w3-border-black">
							<div className="w3-col w3-center w3-padding" style="width:20%">
					...
					<div className="w3-twothird w3-card w3-red w3-padding-32">
					  ...
					  <div className="w3-bar w3-padding-left w3-padding-right">
						<div className="w3-bar-item">
						  ...
						  <input className="w3-input w3-card w3-white" placeholder="Your Email" type="text" id="emailField" required/>
						</div>
						 <div className="w3-bar-item">
						  <label className="w3-left barFont">Password</label> <br/>
						  <input className="w3-input w3-card w3-white" placeholder="Your Password" type="password" id="passwordField" required/>
						</div>
					  </div>
					  <br/>
					  <div className="w3-bar w3-margin-top">
						<button className="w3-button w3-bar-item w3-cyan w3-round barFont">Sign In</button>
					  </div>
					  <br/>
					...
					<div className="w3-twothird w3-card w3-red w3-padding-32">
					  ...
					  <div className="w3-bar w3-padding-left w3-padding-right">
						<div className="w3-bar-item">
						  ...
						  <select className="w3-select w3-card w3-white " id="genderField" required>
						...
						<div className="w3-bar-item w3-margin-left">
						  ...
						  <select className="w3-select w3-card w3-white w3-padding-right" id="titleField" required>
						...
						<div className="w3-bar-item">
						  ...
						  <input className="w3-input w3-card w3-white" placeholder="Your First Name" type="text" id="nameField1" required/>
						</div>
						<div className="w3-bar-item">
						  <label className="w3-left barFont">Last Name</label> <br/>
						  <input className="w3-input w3-card w3-white" placeholder="Your Last Name" type="text" id="nameField2" required/>
						</div>
					  </div>
					  <br/>
					  <div className="w3-bar w3-padding-left w3-padding-right">
						<div className="w3-bar-item">
						 ...
						 <div className="w3-bar-item">
						  ...
						  <input className="w3-input w3-card w3-white" placeholder="Retype Your Password" type="password" id="passwordField2" required/>
						</div>
					  </div>
					  <br/>
					  <div className="w3-bar w3-padding-left w3-padding-right">
						<div className="w3-bar-item">
						  ...
						  <input className="w3-input w3-card w3-white" placeholder="+880-1xxxxxxxxx" type="text" id="mobileField" required/>
						</div>
						 <div className="w3-bar-item">
						  <label className="w3-left barFont">Identification Type</label> <br/>
						  <select className="w3-select w3-card w3-white w3-padding-right" id="idTypeField" required>
						 ...
						 <div className="w3-bar-item">
						  ...
						  <input className="w3-input w3-card w3-white" placeholder="Number according to chosen ID Type" type="text" id="idValField" required/>
						</div>
					  </div>
					  <br/> 
					  <div className="w3-bar w3-margin-top">
						<button className="w3-button w3-bar-item w3-cyan w3-round barFont">Sign Up</button>
					  </div>
					  <br/>
					</div>
				  </div>
